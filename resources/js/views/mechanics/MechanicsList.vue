                ...
                <div class="col-8">
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <button v-tooltip="'Szukaj'" @click="getMechanics" type="button" class="btn btn-outline-secondary"><i class="fas fa-search"></i></button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <table class="table">
                    ...
                    <tr v-for="mechanic in mechanics" :key="mechanic.id">
                        ...
                        <td class="text-center">
                            <router-link v-tooltip="'Edytuj'" tag="button" :to="{name: 'mechanicsEditMechanic', params: {id: mechanic.id}}" class="btn btn-outline-secondary m-1"><i class="fas fa-user-edit"></i></router-link>
                            <button v-tooltip="'Usuń'" class="btn btn-outline-danger m-1" @click="deleteMechanic(mechanic)"><i class="fas fa-trash-alt"></i></button>
                        </td>
                    </tr>
                    </tbody>
                </table>
        ...
        methods: {
            deleteMechanic(mechanic) {
                ...
                .then(() => {
                    ...
                    .then(() => {
                        this.$notify("Pomyślnie usunięto mechanika !", "", "success").then(() => {
                            this.getMechanics();
                        })
                    })
                })
